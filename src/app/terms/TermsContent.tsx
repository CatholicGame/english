    ...
    <div className="mx-auto max-w-[720px] px-4 py-8 text-[17px] leading-relaxed">
      ...
      {lang === "vi" ? (
        <>
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">1. Dịch vụ</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">2. Tài khoản</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">3. Dùng thử &amp; thanh toán</h2>
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">4. Nội dung do AI tạo ra</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">5. Hành vi bị cấm</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">6. Thay đổi điều khoản</h2>
          <p className="mt-2">
            Điều khoản có thể được cập nhật theo thời gian. Phiên bản mới nhất luôn được đăng tại trang này.
          </p>

          <h2 className="mt-6 text-[19px] font-extrabold">7. Liên hệ</h2>
          <p className="mt-2">
        ...
        <>
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">1. Service</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">2. Account</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">3. Trial &amp; payment</h2>
          <ul className="mt-2 list-disc pl-5">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">4. AI-generated content</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">5. Prohibited conduct</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-6 text-[19px] font-extrabold">6. Changes to these terms</h2>
          <p className="mt-2">
            These terms may be updated over time. The latest version is always published on this page.
          </p>

          <h2 className="mt-6 text-[19px] font-extrabold">7. Contact</h2>
          <p className="mt-2">
