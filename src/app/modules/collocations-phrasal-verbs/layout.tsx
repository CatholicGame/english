...
export default function ModuleLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ProgressProvider storageKey={MODULE_KEY}>
      ...
      <div className="min-h-[calc(var(--real-vh,100vh)-3rem)] bg-bg lg:mx-auto lg:flex lg:w-full lg:max-w-[min(90vw,2400px)] lg:flex-row lg:items-start lg:border-x-2 lg:border-[color:var(--color-divider)]">
        {!hideNav && (
