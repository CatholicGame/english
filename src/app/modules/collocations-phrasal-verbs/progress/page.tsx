  ...
  return (
    <div>
      ...
      <div className="divider-b px-4 py-4">
        ...
        <div className="mt-1.5 flex justify-between text-[16px] tracking-wider text-neutral-600 uppercase">
          <span>{fromLabel}</span>
          <span>Today</span>
        </div>
      </div>
        ...
        <div className="divider-b px-4 py-4 lg:border-b-0">
          ...
          {mastery.map((m) => (
            <div key={m.label} className="mb-3">
              <div className="mb-1 flex justify-between text-[16px]">
                <span>{m.label}</span>
        ...
        <div className="px-4 py-4">
          ...
          {groups.map((g) => (
            <div key={g.label} className="mb-3">
              <div className="mb-1 flex justify-between gap-3 text-[16px]">
