...
export const STRINGS: Record<string, DictEntry> = {
  ...
  // ─── Reviews / ratings ────────────────────────────────────────────────
  "reviews.menuLabel": { vi: "⭐ Đánh giá & góp ý", en: "⭐ Rate & feedback" },
  "reviews.title": { vi: "⭐ Đánh giá ứng dụng", en: "⭐ App reviews" },
  "reviews.loadError": { vi: "Không tải được đánh giá, thử lại sau.", en: "Couldn't load reviews, try again later." },
  "reviews.loading": { vi: "Đang tải...", en: "Loading..." },
  "reviews.count": { vi: "{n} đánh giá", en: "{n} reviews" },
  "reviews.all": { vi: "Tất cả đánh giá", en: "All reviews" },
  "reviews.empty": { vi: "Chưa có đánh giá nào. Hãy là người đầu tiên!", en: "No reviews yet. Be the first!" },
  "reviews.anonymous": { vi: "Ẩn danh", en: "Anonymous" },
  "reviews.replyFrom": { vi: "Phản hồi từ Vocabulary Builder Pro", en: "Reply from Vocabulary Builder Pro" },
  "reviews.namePlaceholder": { vi: "Tên hiển thị (không bắt buộc)", en: "Display name (optional)" },
  "reviews.commentPlaceholder": { vi: "Viết cảm nhận của bạn (không bắt buộc)...", en: "Write your feedback (optional)..." },
  "reviews.submitFailed": { vi: "Gửi đánh giá thất bại, thử lại sau.", en: "Couldn't submit your review, try again later." },
  "reviews.sending": { vi: "Đang gửi...", en: "Sending..." },
  "reviews.update": { vi: "Cập nhật đánh giá", en: "Update review" },
  "reviews.submit": { vi: "Gửi đánh giá", en: "Submit review" },
  "reviews.thanks": { vi: "Cảm ơn bạn đã đánh giá! 🙏", en: "Thanks for your review! 🙏" },
  "reviews.editAgain": { vi: "Sửa lại đánh giá", en: "Edit your review" },
  "reviews.prompt.title": { vi: "Bạn thấy app thế nào?", en: "How do you like the app?" },
  "reviews.prompt.body": { vi: "Đánh giá của bạn sẽ hiển thị công khai cho mọi người dùng khác.", en: "Your review will be shown publicly to other users." },
  "reviews.neverAgain": { vi: "Không hiển thị lại", en: "Don't show again" },
  "reviews.star.aria": { vi: "sao", en: "stars" },
  "reviews.picker.aria": { vi: "Chọn số sao đánh giá", en: "Choose a star rating" },
  "reviews.picker.starAria": { vi: "{n} sao", en: "{n} stars" },
  "reviews.picker.prompt": { vi: "Chạm vào sao để đánh giá", en: "Tap a star to rate" },
  "reviews.caption.1": { vi: "Rất tệ 😢", en: "Very bad 😢" },
  "reviews.caption.2": { vi: "Chưa tốt 😕", en: "Not great 😕" },
  "reviews.caption.3": { vi: "Bình thường 😐", en: "Okay 😐" },
  "reviews.caption.4": { vi: "Tốt 🙂", en: "Good 🙂" },
  "reviews.caption.5": { vi: "Tuyệt vời! 🤩", en: "Excellent! 🤩" },

  // ─── Grammar in Use (exercise chrome, shared across every unit) ───────
  "grammar.continue": { vi: "Tiếp tục", en: "Continue" },
  "grammar.toPractice": { vi: "Sang phần thực hành", en: "Go to practice" },
  "grammar.result": { vi: "Kết quả", en: "Result" },
  "grammar.scoreCorrect": { vi: "{correct}/{total} đúng", en: "{correct}/{total} correct" },
  ...
  "grammar.reading": { vi: "Bài đọc", en: "Reading" },
  "grammar.viewVietnamese": { vi: "Tiếng Việt", en: "Vietnamese" },
  "grammar.viewOriginal": { vi: "Bản gốc", en: "Original" },
  "grammar.showOriginalLine": { vi: "Xem câu gốc tiếng Anh", en: "Show the English original" },
  "grammar.showViLine": { vi: "Xem nghĩa tiếng Việt", en: "Show the Vietnamese meaning" },
  "grammar.example": { vi: "Ví dụ trong sách", en: "Worked example" },
  "grammar.yourAnswer": { vi: "Bạn viết:", en: "You wrote:" },
  "grammar.filledCount": { vi: "Đã làm {done}/{total}", en: "{done}/{total} answered" },
  "grammar.judgeOk": { vi: "Đúng rồi", en: "Correct as is" },
  "grammar.judgeFix": { vi: "Cần sửa", en: "Needs fixing" },
  "grammar.fixPlaceholder": { vi: "Sửa \"{text}\" thành...", en: "Correct \"{text}\" to..." },
  "grammar.alreadyCorrect": { vi: "Câu này đúng, không cần sửa.", en: "This sentence is already correct, no fix needed." },
  "grammar.completeUnit": { vi: "Hoàn thành unit", en: "Finish unit" },
  "grammar.grading": { vi: "Đang chấm...", en: "Grading..." },
  "grammar.submitToAi": { vi: "Nộp câu cho AI", en: "Submit to AI" },
  "grammar.writeSentencePlaceholder": { vi: "Viết câu của bạn ở đây...", en: "Write your sentence here..." },
  "grammar.stepKind.rule": { vi: "Học", en: "Learn" },
  "grammar.stepKind.practice": { vi: "Thực hành", en: "Practice" },
  "grammar.stepKind.aiPractice": { vi: "Luyện AI", en: "AI practice" },
  "grammar.unitNotFound": { vi: "Không tìm thấy unit này.", en: "This unit was not found." },
  "grammar.allUnits": { vi: "Tất cả unit", en: "All units" },
  "grammar.unitComplete": { vi: "Đã hoàn thành unit", en: "Unit complete" },
  "grammar.scoreExcellent": { vi: "Xuất sắc.", en: "Excellent." },
  "grammar.scoreGood": { vi: "Khá tốt.", en: "Good work." },
  "grammar.scoreReview": { vi: "Nên xem lại quy tắc.", en: "You should review the rules." },
  "grammar.correctInPractice": { vi: "{correct}/{total} câu đúng trong các bài thực hành.", en: "{correct}/{total} correct across the practice exercises." },
  "grammar.retry": { vi: "Làm lại", en: "Retry" },
  "grammar.exit": { vi: "Thoát", en: "Exit" },
