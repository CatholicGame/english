...
export function UnitClient({ slug }: { slug: string }) {
  ...
  return (
    <div>
      ...
      {items.length === 0 && (
        <div className="px-4 py-8 text-[16px] text-neutral-600">
          ...
          return (
            ...
            >
              <span className="min-w-0 flex-1">
                <span className="block text-[18px] font-extrabold leading-snug">{it.term}</span>
                <span className="mt-0.5 block truncate text-[16px] text-neutral-600">{it.vi}</span>
              </span>
